...
export class ExperimentationService {
   ...
   */
  async startExperiment(campaignId: string, hypothesis: string, variants: { name: string; configuration: any }[]) {
   ...
   */
  async concludeExperiment(experimentId: string, decision: string) {
