...
describe('Marketing Experiment Service', () => {
  ...
  it('should create an experiment with variants', async () => {
    (prisma.marketingExperiment.create as any).mockResolvedValue({
      id: 'exp-1',
      campaignId: 'camp-1',
  ...
  it('should record observations for variants', async () => {
    (prisma.marketingObservation.create as any).mockResolvedValue({
      id: 'obs-1',
      variantId: 'v-1',
      metric: 'QIE',
      value: 1
  ...
  it('should evaluate an experiment and select the highest QIE winner', async () => {
    (prisma.marketingExperiment.findUnique as any).mockResolvedValue({
      id: 'exp-1',
      hypothesis: 'Test',
      variants: [
        {
    ...
    (prisma.marketingExperiment.update as any).mockResolvedValue({});
