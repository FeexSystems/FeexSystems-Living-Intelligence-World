...
describe.skip("MarketingHybridRetrievalService", () => {
  ...
  let service: MarketingHybridRetrievalService;
  ...
  describe("searchClaims", () => {
    it("should retrieve semantic hits and hydrate them from DB", async () => {
      ...
      (prisma.marketingClaim.findMany as any).mockResolvedValue(mockClaims);
  ...
  describe("searchContent", () => {
    it("should retrieve semantic hits and hydrate them from DB", async () => {
      ...
      (prisma.marketingContentAsset.findMany as any).mockResolvedValue(mockAssets);
