...
describe("ClaimGraphService", () => {
  ...
  it("should find orphan claims correctly", async () => {
    ...
    vi.mocked(prismaMock.marketingClaim.findMany).mockResolvedValue(claims as any);
  ...
  it("should traverse from evidence and propagate changes", async () => {
    ...
    vi.mocked(prismaMock.marketingClaimEvidence.findMany).mockResolvedValue(evidenceLinks as any);
