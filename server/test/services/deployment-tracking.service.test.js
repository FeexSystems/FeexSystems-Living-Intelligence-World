 function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }/** @vitest-environment node */
...
describe('DeploymentTrackingService', () => {
  ...
  describe('updateDeploymentStatus', () => {
    it('should update deployment status', async () => {
      ...
      expect(_optionalChain([deployment, 'optionalAccess', _ => _.status])).toBe('RUNNING');
    ...
    it('should set completion time for completed deployments', async () => {
      ...
      expect(_optionalChain([deployment, 'optionalAccess', _2 => _2.status])).toBe('SUCCESS');
      expect(_optionalChain([deployment, 'optionalAccess', _3 => _3.completedAt])).toBeDefined();
    });
    ...
    it('should update logs when provided', async () => {
      ...
      expect(_optionalChain([deployment, 'optionalAccess', _4 => _4.logs])).toEqual(logs);
    });
  });
  ...
  describe('addDeploymentLog', () => {
    it('should add log entry to deployment', async () => {
      ...
      const logs = _optionalChain([deployment, 'optionalAccess', _5 => _5.logs]) ;
    ...
    it('should append to existing logs', async () => {
      ...
      const logs = _optionalChain([deployment, 'optionalAccess', _6 => _6.logs]) ;
  ...
  describe('cancelDeployment', () => {
    ...
    it('should cancel running deployment', async () => {
      ...
      expect(_optionalChain([deployment, 'optionalAccess', _7 => _7.status])).toBe('CANCELED');
      expect(_optionalChain([deployment, 'optionalAccess', _8 => _8.completedAt])).toBeDefined();
  ...
  describe('getDeploymentAnalytics', () => {
    ...
    it('should group deployments by day', async () => {
      ...
      expect(_optionalChain([dayWithDeployments, 'optionalAccess', _9 => _9.successCount])).toBeGreaterThanOrEqual(0);
      expect(_optionalChain([dayWithDeployments, 'optionalAccess', _10 => _10.failureCount])).toBeGreaterThanOrEqual(0);
    });
  });
  ...
  describe('getDeploymentTrends', () => {
    ...
    it('should categorize failure reasons correctly', async () => {
      ...
      expect(_optionalChain([timeoutFailure, 'optionalAccess', _11 => _11.count])).toBe(1);
    });
