...
describe('WaveBackground WebGL Component', () => {
  describe('2.4.1 - Canvas Context Availability', () => {
    ...
    it('should return WebGL context from mock polyfill', () => {
      ...
      expect(typeof _optionalChain([context, 'optionalAccess', _ => _.viewport])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _2 => _2.clear])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _3 => _3.clearColor])).toBe('function');
    });
  ...
  describe('WebGL Context API Compliance', () => {
    it('should have standard WebGL constants', () => {
      ...
      // Act & Assert
      expect(_optionalChain([(context ), 'optionalAccess', _4 => _4.VERTEX_SHADER])).toBeDefined();
      expect(_optionalChain([(context ), 'optionalAccess', _5 => _5.FRAGMENT_SHADER])).toBeDefined();
      expect(_optionalChain([(context ), 'optionalAccess', _6 => _6.COMPILE_STATUS])).toBeDefined();
      expect(_optionalChain([(context ), 'optionalAccess', _7 => _7.LINK_STATUS])).toBeDefined();
    });
    ...
    it('should support shader compilation methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _8 => _8.createShader])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _9 => _9.compileShader])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _10 => _10.getShaderParameter])).toBe('function');
    });
    ...
    it('should support program linking methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _11 => _11.createProgram])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _12 => _12.attachShader])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _13 => _13.linkProgram])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _14 => _14.getProgramParameter])).toBe('function');
    });
    ...
    it('should support uniform methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _15 => _15.getUniformLocation])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _16 => _16.uniform1f])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _17 => _17.uniform2f])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _18 => _18.uniform3f])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _19 => _19.uniform4f])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _20 => _20.uniformMatrix4fv])).toBe('function');
    });
    ...
    it('should support attribute methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _21 => _21.getAttribLocation])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _22 => _22.enableVertexAttribArray])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _23 => _23.vertexAttribPointer])).toBe('function');
    });
    ...
    it('should support buffer methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _24 => _24.createBuffer])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _25 => _25.bindBuffer])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _26 => _26.bufferData])).toBe('function');
    });
    ...
    it('should support drawing methods', () => {
      ...
      // Act & Assert
      expect(typeof _optionalChain([context, 'optionalAccess', _27 => _27.drawArrays])).toBe('function');
      expect(typeof _optionalChain([context, 'optionalAccess', _28 => _28.drawElements])).toBe('function');
    });
  });
});
