 ...
 *
 * Restore ASAP:
 *   git checkout hotfix/restore-index-pass11
 *   cp path/to/Index.pass11-synced.tsx client/pages/Index.tsx
 *   npm run typecheck && npm run build
 *   git add client/pages/Index.tsx && git commit && git push
 *   # open PR → main and merge
 */
