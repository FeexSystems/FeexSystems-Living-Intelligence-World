...
class TelemetryClient {constructor() { TelemetryClient.prototype.__init.call(this);TelemetryClient.prototype.__init2.call(this);TelemetryClient.prototype.__init3.call(this); }
   __init() {this.endpoint = '/api/marketing/telemetry/events'}
  
  // Use a local queue for batching to reduce network requests
   __init2() {this.queue = []}
   __init3() {this.isProcessing = false}
